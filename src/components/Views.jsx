...
import { activityFeed, teamMembers, docGroups, docIcon, initialProcurement, budgetSeries, expenseCategories, progressData, usageData, PIE_COLORS } from "../data";

/* ---------------------------------- DASHBOARD ---------------------------------- */
export function Dashboard({ meetings, inventory, notices, tasks, expenses }) {
...
/* ---------------------------------- PROJECTS (KANBAN) ---------------------------------- */
export function Projects({ liveTasks }) {
